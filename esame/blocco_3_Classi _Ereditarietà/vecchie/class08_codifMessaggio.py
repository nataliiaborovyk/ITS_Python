...
Si crei una classe astratta chiamata DecodificatoreMessaggio che abbia un solo metodo astratto decodifica(testoCodificato), dove testoCodificato sarà il messaggio da decodificare. Il metodo ritornerà il messaggio decodificato.
